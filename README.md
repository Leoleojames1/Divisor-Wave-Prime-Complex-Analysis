...
These waveforms showcase and breakdown the structure of prime numbers and represent them in a new light, the Divisor Wave Prime Complex Analysis plotting software is an infinite domain which I have defined for researching these special functions. 
