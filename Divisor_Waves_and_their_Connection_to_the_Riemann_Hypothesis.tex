...
\end{align*}
where B(x) is 0 when composite, and nonzero when prime. Ultimately the series plot for H(z) reflects the relationship that $0^{nonzero} = 0$ and that $0^{0} = 1$, which is the key to outputting the primes from H(z) in binary.
...
\begin{align*}
	L(z) = {\prod_{n=2}^z \left( (-1)^n \right)}
\end{align*}
...
\begin{align*}
	M(z) = {\prod_{n=2}^z \left( (-1)^n [ \prod_{k=2}^x (-1)^k ] \right)}
\end{align*}

which can be expanded as,
\begin{align*}
	M(z) = {\prod_{n=2}^z (-1)^{k}*((-1)^{2}(-1)^{3}\ldots(-1)^{x}) }
\end{align*}
...
\begin{align*}
	N(z) = \prod_{n=2}^z \left( \prod_{k=2}^z \left( (-1)^n (-1)^k \right) \right)
\end{align*}

and upon first expansion providing,
\begin{align*}
	N(z) = \prod_{n=2}^z \left( (1)^{n} * ((-1)^{2}*(-1)^{3}\ldots(-1)^{x}) \right)
\end{align*}
...
\begin{align*}
	O(z) = {{\prod_{n=2}^z \left( (-2)^n \right)}}^{{\prod_{k=2}^z \left( (-1)^k \right)}}
\end{align*}
...
\begin{align*}
	P(z) = {{\prod_{n=2}^z \left( (-2)^n \right)}}^{{\prod_{k=2}^z \left( (-2)^k \right)}}
\end{align*}
...
The next step is articulating the powers of 2 such that the outcome
We follow the rule the $(2)^{0}=(1)$ & $(2)^{1}=(2)$,

\begin{align*}
\includegraphics[scale=0.30]{graphs/Q1_BIG}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.30]{graphs/R1_actual_BIG}
\end{align*}
...
\begin{align*}
C(s) = (\frac{1}{1 - 2^{s}})(\frac{1}{1 + 3^{-s}})(\frac{1}{1 + 0^{-s}})(\frac{1}{1 - 5^{-s}})(\frac{1}{1 + 0^{-s}})(\frac{1}{1 + 7^{-s}})(\frac{1}{1 + 0^{-s}})(\frac{1}{1 + 0^{-s}})(\frac{1}{1 + 0^{-s}})(\frac{1}{1 + 11^{-s}})(\frac{1}{1 + 0^{-s}})(\frac{1}{1 - 13^{-s}}) \ldots
\end{align*}
...
\begin{align*}
C(s) = (\frac{1}{1 - 2^{s}})(\frac{1}{1 + 3^{-s}})(\frac{1}{1 - 5^{-s}})(\frac{1}{1 + 7^{-s}})(\frac{1}{1 + 11^{-s}})(\frac{1}{1 - 13^{-s}})(\frac{1}{1 - 17^{-s}})(\frac{1}{1 + 19^{-s}})(\frac{1}{1 + 23^{-s}}) \ldots
\end{align*}

now, C(s) will be subtracted from the Euler Product Representation of the Dirichlet Eta Function, ("Convergence of Dirichlet Series and Euler Products", Peter Zvengrowski), where Peter Zvengrowski defines the Euler Product for the Dirichlet Eta Function as,

\begin{align*}
	\eta(s) = {\prod_{p} \left( \frac{1}{1+(-1)^{s}p^{s} \right)}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.30]{graphs/S1_actual_BIG}
\end{align*}
