...
\begin{align*}
\includegraphics[scale=0.45]{graphs/3D_Complex_Graphs/riesz_sin/HD_Riesz_sin_7_12_n7}
\end{align*}
Figure 22: 3D Plot of C(z) in the complex plane on the interval 1 $<$ x $<$ 17

\begin{align*}
\includegraphics[scale=0.45]{graphs/3D_Complex_Graphs/riesz_sin/HD_Riesz_sin_7_12_n6}
\end{align*}
Figure 23: 3D Plot of C(z) in the complex plane on the interval 7 $<$ x $<$ 12
...
\end{align*}
Figure 23: 3D Complex Riesz product for cos on the interval 2 $<$ x $<$ 12

\begin{align*}
\includegraphics[scale=0.45]{graphs/3D_Complex_Graphs/riesz_cos/HD_Riesz_cos_2_12_n3}
\end{align*}
Figure 24: 3D Complex Riesz product for cos on the interval 5 $<$ x $<$ 8
...
\end{align*}
Figure 33: 3D plot Of I(z) in the complex plane to showcase the zeros of the combined function.
...
\end{align*}
Figure 29: 3D Complex Plot for Viete's product of cos

\begin{align*}
\includegraphics[scale=0.30]{graphs/3D_Complex_Graphs/Viete_cos/Viete_cos_norm_3}
\end{align*}
Figure 30: 3D Complex Plot for Viete's product of cos with alternate colorization

This Plot showcases the zeros of vietes product as they are spaced in the discrete space of the complex plane.
