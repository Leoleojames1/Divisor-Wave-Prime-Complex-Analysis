...
\newpage
\subsection*{VIII. Initial Description of Function H(z)}
...
\newpage
\subsection*{IX. Initial Description of Function I(z)}
...
\newpage
\subsection*{X. Initial Description of Function J(z)}
...
\newpage
\subsection*{XI. Initial Description of Function K(z)}
...
\newpage
\subsection*{XII. Initial Description of Function L(z)}
...
\newpage
\subsection*{XVIII. Complex definition for \zeta(s)}
We define the infinite product in the complex plane for $\zeta(x+iy)$, where $s = x + iy$ as the following:
