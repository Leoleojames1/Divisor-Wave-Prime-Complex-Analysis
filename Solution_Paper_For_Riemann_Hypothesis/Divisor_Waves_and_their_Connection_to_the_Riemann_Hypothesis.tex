...
\begin{align*}
\includegraphics[scale=0.4]{DW_2}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.4]{sieve}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.5]{cuspcurve}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.55]{norm_cuspcurve}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.35]{prime_indicator_og}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.4]{ComplexPlot_prodprodforsin_1}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.4]{ComplexPlot_prodprodforsin_9}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.3]{Complex_product_23_n_0-28_}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.3]{Complex_product_17_n_2-28__imaginary_scalar_logarithm}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.35]{prime_indicator_norm}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.30]{1+sin_prod}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.30]{1+cos_prod}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.30]{prod_1+tan}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.30]{1+sin_prod_xprimefunc}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.30]{1+cos_prod_xprimefunc}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.30]{1+tan_prod_xprimefunc}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.3]{Complex_product_1_n_2-14_factored_form}
\end{align*}
...
\begin{align*}
\includegraphics[scale=0.25]{19_waveform_invert}
\end{align*}

\subsection*{j(z), J(z), k(z), K(z), L(z), and B(z) at real(z) = 2 to 14:}
\begin{align*}
\includegraphics[scale=0.30]{sin_cos_tan_primefunc}
\end{align*}

\subsection*{j(z), J(z), k(z), K(z), L(z), and B(z) at real(z) = 6 to 11:}
\begin{align*}
\includegraphics[scale=0.30]{6_11_sin_cos_tan_primefunc}
\end{align*}

\subsection*{j(z), J(z), k(z), K(z), L(z), and B(z) at real(z) = 9:}
\begin{align*}
\includegraphics[scale=0.30]{9_sin_cos_tan_primefunc}
\end{align*}

\subsection*{j(z), J(z), k(z), K(z), L(z), and B(z) at real(z) = 11:}
\begin{align*}
\includegraphics[scale=0.30]{11_sin_cos_tan_primefunc}
\end{align*}

\subsection*{j(z), J(z), k(z), K(z), L(z), and B(z) at real(z) = 13:}
\begin{align*}
\includegraphics[scale=0.30]{13_sin_cos_tan_primefunc}
\end{align*}

\subsection*{j(z), J(z), k(z), K(z), L(z), and B(z) at real(z) = 15:}
\begin{align*}
\includegraphics[scale=0.30]{15_sin_cos_tan_primefunc}
\end{align*}

\subsection*{j(z), J(z), k(z), K(z), L(z), and B(z) at real(z) = 17:}
\begin{align*}
\includegraphics[scale=0.30]{17_sin_cos_tan_primefunc}
\end{align*}

\subsection*{j(z), J(z), k(z), K(z), L(z), and B(z) at real(z) = 19:}
\begin{align*}
\includegraphics[scale=0.30]{19_sin_cos_tan_primefunc}
\end{align*}

\subsection*{j(z), J(z), k(z), K(z), L(z), and B(z) at real(z) = 21 and 22:}
\begin{align*}
\includegraphics[scale=0.30]{21_22_sin_cos_tan_primefunc}
\end{align*}

\subsection*{j(z), J(z), k(z), K(z), L(z), and B(z) at real(z) = 21 and 22:}
\begin{align*}
\includegraphics[scale=0.30]{23_sin_cos_tan_primefunc}
\end{align*}

\subsection*{Graph the infinite product representation of zeta at n = 2 to 11 at y = -10, 10 magnification}
\begin{align*}
\includegraphics[scale=0.30]{Complex_product_2_n2-11_imaginary_component_scalar}
\end{align*}

\subsection*{Graph the infinite product representation of zeta at n = 2 to 11 at y = -100, 100 magnification}
\begin{align*}
\includegraphics[scale=0.30]{Complex_product_4_n2-11_zeta_prod}
\end{align*}

\subsection*{Graph the infinite product b(z) at n = 0 to 84}
\begin{align*}
\includegraphics[scale=0.30]{Complex_product_11_n0-84_Imaginary_scalar}
\end{align*}

\subsection*{Graph the infinite product b(z) at n = 10 to 28}
\begin{align*}
\includegraphics[scale=0.30]{Complex_product_12_n10-28_imaginary_scalar}
\end{align*}

\subsection*{Graph the infinite product b(z) at n = 2 to 11 utilizing the imaginary component for magnification}
\begin{align*}
\includegraphics[scale=0.30]{Complex_product_1_n2-11_imaginary_component_scalar}
\end{align*}
